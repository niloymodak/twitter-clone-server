...
async function run() {
    try {
        ...
        const postCollection = client.db("cloneTwitter").collection("posts"); // this collection is for team-ekt
        const userCollection = client.db("cloneTwitter").collection("users"); // this collection is for team-srv
